...
```bash
./scripts/build-worker-linux.sh 0.11.0
# -> dist/linux-worker/stress-strike-worker-v0.11.0-linux-amd64.tar.gz
#    dist/linux-worker/stress-strike-worker-v0.11.0-linux-arm64.tar.gz
```
...
```bash
tar -xzf stress-strike-worker-v0.11.0-linux-amd64.tar.gz
sudo install -m 0755 stress-strike-worker-v0.11.0-linux-amd64/stress-strike-worker /usr/local/bin/
sudo install -m 0644 stress-strike-worker-v0.11.0-linux-amd64/stress-strike-worker.service /etc/systemd/system/
sudo mkdir -p /etc/stress-strike
sudo cp stress-strike-worker-v0.11.0-linux-amd64/worker.env.example /etc/stress-strike/worker.env
...
```bash
docker build -f Dockerfile.worker -t stress-strike-worker:0.11.0 .
